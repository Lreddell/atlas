...
Atlas includes Monocraft font files under:

- `public/assets/fonts/Monocraft-ttf/`

Monocraft is a third-party font created by IdreesInc.

Monocraft is licensed under the **SIL Open Font License 1.1**.
...
If additional third-party fonts, audio, textures, models, code, or other materials are added to Atlas in the future, they should be listed in this file along with their source and license terms.
