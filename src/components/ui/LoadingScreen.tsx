...
const LOADING_TIPS = [
    ...
    "Full hunger and saturation regenerate health faster than normal hunger recovery.",
    ...
    "Mining tools show a direct Mining Power value instead of an unclear speed multiplier.",
    "Oak, spruce, birch, cherry, jungle, dark oak, and acacia logs craft into their own plank sets.",
    "Raw iron, raw copper, and raw gold can all be smelted into ingots in a furnace.",
    "Atlas worlds include oceans, rivers, forests, deserts, tundra, mesas, jungles, savannas, taiga, swamps, beaches, mountains, and more.",
    "Lush Caves and Dripstone Caves are underground biome regions with their own terrain details and music behavior.",
    "Swamps are waterlogged lowlands, and sandy beaches now form along most coastlines.",
    "Craft a Boat from 5 planks and use it on water to launch it. Right-click to board and Sneak to dismount.",
    ...
    "Bolts repelled off your boots charge Flux. When it is full, your next polarity flip bursts.",
    "The Warden's Aegis form hangs from one tower crystal at a time. Break that crystal and it comes crashing down.",
    ...
    "Armor reduces combat damage but wears out. Falls, fire, and drowning ignore armor.",
    ...
    "Logs can be smelted into charcoal, so torches are possible even before you find coal.",
    ...
    "Leaves can drop saplings, sticks, and sometimes food depending on the tree type.",
    "Atlas music is grouped into tags, so related biomes can share songs without restarting at every border.",
    "The World Editor supports custom terrain, cave, and Magnetic Fields settings that can be saved as presets.",
    "The Magnetic Fields are built as an expedition from the outer rim toward the central arena.",
    "Preparing food, armor, and spare tools before a boss expedition can save a long trip back.",
    "Stone Shores mark rougher coastlines where sand gives way to exposed rock.",
    "Deepslate appears in the deepest parts of the world, where ores use their own deep variants.",
    "Magnetic wall traversal only engages after you make contact with a magnetic surface.",
    "Leaving an unfinished Warden fight resets the encounter so it can be summoned again later.",
    "Cleansed Magnetic Fields remember their progression state when the world is saved.",
    "Armor durability indicators pulse when a piece is close to breaking.",
    "Different biome music tags can share a song pool without restarting the track at every border.",
