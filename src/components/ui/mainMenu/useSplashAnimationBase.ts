...
const SPLASHES = [
    'Face the Magnetic Warden!', 'Procedural!', 'Voxel based!', 'React + Three.js!', 'Infinite world!',
    'Source available!', 'Made with AI!', '100% bugs!', 'Check out the code!', "Don't dig down!",
    'Uses Web Workers!', 'Greedy meshing!', 'Dozens of biomes!', 'Hello World!',
    'Powered by Vite!', 'Diamonds!', 'Look behind you!', 'Splashes are random!',
    'Better than real life!', 'Try the World Editor!', 'Blocky goodness!', 'Undefined behavior!', 'NaN!', '0 FPS!', 'Just one more block...',
    ...
    'No clip? Not today!', "Edge of map? There isn't one!", 'Oops, all edge cases!', "What's New is ready!", 'Debug mode is my love language!',
    ...
    'Eight moon phases!', 'Panorama settings perfectionist.', 'World Editor remembers.',
    'Tune every world!', 'Biome hunting hours!', 'Debug screen jumpscare!', 'Soundtrack swap approved.',
