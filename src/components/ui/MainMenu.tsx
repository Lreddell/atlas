...
const ULTRA_RARE_SPLASHES = [
    "",
    "§6I wonder if anyone will ever see this splash?",
    "§6Use code §lATLAS §r§6for 10% off! Just kidding, it's free!",
    "§6I can't believe it's not Minecraft!",
    "§6Vibe check failed. Please insert more vibes.",
    "§612 FPS on a supercomputer?",
    "§6The block is a lie!",
    "§6Zero crashes today! I swear!",
    "§6Herobrine added!",
    "§6Collision worked perfectly!",
    "§6No TODOs left!",
    "§6Reproduced on first attempt!",
    "§6Bug fixed without new bugs!",
    "§6QA approved this build!",
    "§6One-line fix. No regrets.",
    "§0T H E  V O I D  S T A R E S  B A C K",
    "§6ChatGPT wrote this splash!",
    "§6Hey @Grok, why is the entire game broken?",
    "§kYoushouldn'tbeabletoseethis",
    "§6Playing for the vibes",
    "§6You found a rare splash!",
    "§6Did you know?",
    "§642",
    "§6why am I even writing these?",
    "§650% of the time, it works every time!",
    "§650 shades of blocks!",
    "§6Not owned by Microslop!",
    "§5Clanker approved!",
    "§6why are you still reading this? go play the game!",
    "§6ggs no heals",
    "§680 hours of jeff on marvel rivals!",
    "§6sub to @ry_no_xx on youtube!",
    "§6watch @ry_no_x on twitch!",
    "§cBased and red-pilled",
