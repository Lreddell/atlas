...
export const TUTORIAL_SECTIONS: TutorialSection[] = [
    ...
    },
    {
        ...
        bullets: [
            ...
            'F: Dodge roll; with Polarity Boots it becomes a magnetic dash onto an opposite magnet face or into an opposed Warden, a repel leap away from a matched one, or a launch off a wall',
    ...
    },
    {
        ...
        bullets: [
            ...
            'F is one button, resolved by that rule: a dodge roll with i-frames, a magnetic dash onto an opposite magnet face (or into an opposed, exposed Warden, which arms a Magnet Slam: your next strike lands harder and staggers it), a repel leap away from a matched Warden, or a launch off a wall.',
