        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    ...
                    'Lush and dripstone cave biomes are large but rare regions, lightened deepslate reads clearly under low light, and every ore now has a deepslate variant that generates in the deep band.',
                    'New foods: bananas drop rarely from jungle leaves, glowing Lumen Berries forage from cave glow lichen, and the three craft into a hearty Forager’s Bowl. Dark oak leaves now drop apples.',
            ...
            },
            {
                ...
                items: [
                    ...
                    'Restyled the health and hunger bars to match the armor pips — angled, stylized hearts and drumsticks with an outline and highlight glint.',
            ...
            },
            {
                ...
                items: [
                    ...
                    'Music is now tag-based: each tag is a folder of songs and every biome lists the tags it plays, so biomes can share identical music, stack multiple tags, and keep a shared song playing across a biome border instead of restarting.',
            ...
            },
            {
                ...
                items: [
                    ...
                    'Fixed distant oceans rendering see-through — deep water now keeps its floor at any distance.',
                    ...
                    'The tutorial now covers magnetism, the Warden, gear durability, and current commands; smoother performance around magnets.',
