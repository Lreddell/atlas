      ...
      {(appState === 'game' || appState === 'loading') && (
          <>
            ...
            >
                ...
                <ChunkStreamer /> 
                <AudioListenerUpdater isPaused={isPaused} gameMode={gameMode} />
